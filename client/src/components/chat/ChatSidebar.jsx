...
export default function ChatSidebar({
  ...
  // If there's no active convo, sidebar IS the primary view (no overlay needed)
    ...
    <>
      ...
      <aside
        className={`
          ...
          ${overlayMode
            ? `fixed inset-y-0 left-0 z-40 w-full max-w-[340px] shadow-soft transition-[transform,opacity] duration-200 ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`
            : `fixed inset-y-0 left-0 z-40 w-full max-w-[340px] shadow-soft transition-[transform,opacity] duration-200 ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`
          }
        `}
      >
